...
wallpaperPath = ("/home/nico/.config/awesome/wallpapers/mac2.jpg")
themePath = ("../themeTest.lua")
themeVariables = ["theme.bg_normal","theme.bg_focus","theme.bg_urgent","theme.bg_minimize","theme.fg_normal"]
